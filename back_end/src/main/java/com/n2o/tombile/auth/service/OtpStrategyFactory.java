...
public class OtpStrategyFactory {
    ...
    @PostConstruct
    public void init() {
        strategies.put(OtpType.VERIFY_EMAIL, new OtpStrategyVerifyEmail(userService, otpService, roleStrategyFactory));
        strategies.put(OtpType.RECOVER_PASSWORD, new OtpStrategyRecoverPassword(userService, otpService, roleStrategyFactory));
    }
